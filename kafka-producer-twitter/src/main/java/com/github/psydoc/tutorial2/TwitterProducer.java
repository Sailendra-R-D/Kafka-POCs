package com.github.psydoc.tutorial2;
...
public class TwitterProducer {
        ...
        while (!client.isDone()) {
            ...
            if (msg != null) {
                ...
                producer.send(new ProducerRecord<>("twitter_tweets",null,msg),(RecordMetadata recordMetadata, Exception e)->{
                    if(e!=null){
                        logger.error("something bad really happened",e);
                    }
                });
            }
        }
    ...
    public KafkaProducer<String,String> createKafkaProducer(){
        ...
        properties.setProperty(ProducerConfig.MAX_BLOCK_MS_CONFIG, "5"); // kafka 2.0 >= 1.1 so we can
